...
<body >
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <h2 class="text-white mb-4">Create Your Account </h2><br>
         </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="form-row">
                ...
                <input type="text" class="form-control" id="n" name="n" placeholder="name" value="" required>
                <div class="invalid-feedback">Enter a name</div>
                </div>
                <div class="col-md-3 mb-3">
                <label style="color:white;" for="validationCustom02">Age</label>
                <input type="text" class="form-control" id="age" name="age" placeholder="Age" value="" required>
  ...
  <div class="form-row">
    ...
    <textarea class="form-control " id="description" name="description" placeholder="Tell us about you" required></textarea>
...
<div class="form-row">
  ...
  <input type="submit" class="btn btn-primary" value="Create Account" onclick="myFunction()"name="submit" >
