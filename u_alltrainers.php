...
<body id="page-top">
  ...
  <!-- all trainers -->
  <section id="trainers" class="about-section text-center bg-black">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          
          <h2 class="text-white mb-4">All Trainers </h2><br>
         </div>
      </div>
...
$sql = "SELECT  fullname, age, gender, city, detail, experience, price, email, mobile FROM trainers WHERE fullname != '' ;";
